/**
 * Google Maps styling configurations for light and dark themes
 * Referenced by Article XI of the constitution
 *
 * Light theme: Clean greyscale with subtle colors
 * Dark theme: Muted blue with minimal elements
 */

export const lightModeMapStyle: google.maps.MapTypeStyle[] = [
  {
...
export const darkModeMapStyle: google.maps.MapTypeStyle[] = [
  {
    featureType: "all",
