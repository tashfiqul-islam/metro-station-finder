 ...
 */
export const TakaAmountSchema = z
  .number()
  .int()
  .nonnegative()
  .brand<"TakaAmount">();
...
export function parseGeolocationResult(
  value: unknown
): ValidationResult<GeolocationResultInput> {
...
export function parsePlacePrediction(
  value: unknown
): ValidationResult<PlacePredictionInput> {
...
export function isGeolocationResultInput(
  value: unknown
): value is GeolocationResultInput {
  return GeolocationResultSchema.safeParse(value).success;
}

export function isPlacePredictionInput(
  value: unknown
): value is PlacePredictionInput {
