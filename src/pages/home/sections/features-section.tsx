...
const FEATURES: FeatureItem[] = [
  {
    ...
    description:
      "Search the MRT-6 station list by name and move straight to the stop you actually need.",
  ...
  },
  {
    ...
    description:
      "See the segment, count the stops, and understand the stretch of line you are taking.",
    icon: MapTrifoldIcon,
  ...
  },
  {
    ...
    description:
      "Keep station order, termini, and route context in one scan instead of scattered screenshots.",
    icon: SpeakerHighIcon,
    outcome: "Line context",
    size: "md",
  ...
  },
  {
    ...
    description:
      "Rely on clear labels, semantic links, and responsive layouts built around quick checks.",
    icon: WheelchairIcon,
    outcome: "Accessible flow",
    size: "md",
    title: "Use it with less friction",
  },
] as const;
...
const FeatureCard = ({
  ...
  <article
    className={cn(
      "section-card group relative flex h-full flex-col overflow-hidden p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-[0_24px_70px_oklch(0_0_0/0.10)]",
      size === "lg" && "min-h-64",
    )}
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
        <ViewportAnimation>
          <div className="max-w-xl">
            <SectionHeading
              description="The product is shaped around the decisions riders repeat most: locate a stop, price the trip, understand the route, and move through the interface without extra work."
            ...
            <div className="section-panel mt-10 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-muted-foreground">
                Not a dashboard. Not a transport encyclopedia. The home page keeps the model
                visible: static MRT-6 facts first, interface polish second, no hidden magic.
              </p>
            </div>
          </div>
        </ViewportAnimation>
