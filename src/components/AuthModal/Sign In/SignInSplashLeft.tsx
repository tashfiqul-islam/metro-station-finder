 ...
 */
const SignInSplashLeft: React.FC<SignInSplashLeftProps> = ({ onSignInClick, show }) => {
  return (
    <div className={`flex flex-col items-center justify-center h-full`}>
      {/* Welcome message */}
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Welcome Back!</h2>
      {/* Instruction text */}
      <p className="text-lg mb-8 text-center text-white">Please sign in with your account details.</p>
      {/* Sign In button */}
      <button
        type="button"
