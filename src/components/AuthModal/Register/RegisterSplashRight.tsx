 ...
 */
const RegisterSplashRight: React.FC<RegisterSplashRightProps> = ({ onRegisterClick }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full">
      {/* Greeting message */}
      <h2 className="text-2xl font-bold mb-4 text-center text-white">Hello, there!</h2>
      {/* Instruction text */}
      <p className="text-lg mb-8 text-center text-white">Register with your details.</p>
      {/* Register button */}
      <button
        type="button"
