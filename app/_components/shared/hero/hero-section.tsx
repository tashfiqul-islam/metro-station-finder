    ...
    return (
      <motion.div
        ...
        transition={{
          ...
          delay: ANIMATION_CONFIG.delays.stats + index * ANIMATION_CONFIG.stagger,
...
export function Hero(): React.ReactElement | null {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-2/3 bg-linear-to-b from-background/70 via-background/20 to-transparent"
      />
      {/* Ambient gradients */}
      <BackgroundGradients />
        ...
        <div className="flex flex-col items-center gap-8 text-center sm:gap-10">
          ...
          >
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed sm:text-xl">
              Find stations, calculate fares, and plan your journey across Dhaka&apos;s MRT-6
