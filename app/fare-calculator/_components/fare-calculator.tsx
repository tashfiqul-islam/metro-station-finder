...
import { useFareCalculatorComplete } from "@/lib/hooks/use-fare-calculator";
 ...
 */
const FareBreakdown = memo(
  ({ breakdown }: { breakdown: NonNullable<Fare["breakdown"]> }) => (
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <FareMetric
                delay={0.1}
                label="Distance"
                value={`${displayFare.distance} km`}
              />
            </div>

            {displayFare.breakdown && (
              <FareBreakdown breakdown={displayFare.breakdown} />
            )}
...
export function FareCalculator() {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-background via-primary/5 to-background px-4 py-8 md:px-6 lg:px-8">
          ...
          >
                ...
                <CardContent className="space-y-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    >
                      ...
                      <Popover
                        onOpenChange={(open) =>
                          dispatch({ type: "SET_ORIGIN_OPEN", payload: open })
                        }
            ...
            <AnimatePresence>
              <FareResultsSection
                ...
                isCalculating={optimisticState.isCalculating}
              />
            </AnimatePresence>
          </div>
